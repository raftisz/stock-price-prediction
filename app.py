...
using Random Forest Regressor trained on 2014–2023 data.
"""
...
st.caption("พยากรณ์ราคาปิดวันถัดไปด้วย Random Forest Regressor | ข้อมูลฝึก: 2014–2023")
...
with tab1:
    ...
    with c_pred:
        ...
        if predict_btn and not errors:
            ...
            # Confidence interval (ใช้ std ของ tree predictions)
            ...
            # แสดง latest prediction จากโมเดลในชุดข้อมูล
